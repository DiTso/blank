	...
	$.fn.reachGoal=function(){if(1==this.length){var a=this.data("goal");if(window.Ya&&a)for(var i in window.Ya._metrika.counters)i="yaCounter"+i.replace(/:\d+$/,""),window[i]&&window[i].reachGoal(a)}return this};

...
(2, 'document', 'text/html', 'Главная', 'О компании', '', 'index', '', 1, 0, 0, 1, 0, '', '', 1, 4, 0, 1, 1, 1, 1493894004, 1, 1494512939, 0, 0, 0, 1493894004, 1, '', 0, 0, 0, 0, 0, 0, 0, 1),
...
(4, 'document', 'text/html', '404', '', '', '404', '', 1, 0, 0, 0, 0, '', '<p>Страница не найдена!</p>', 1, 3, 1002, 1, 1, 1, 1493894251, 1, 1493894251, 0, 0, 0, 1493894251, 1, '', 0, 0, 0, 0, 0, 0, 1, 1);
